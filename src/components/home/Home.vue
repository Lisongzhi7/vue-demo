...
<!--        <span @click="getRecData()"> 查看上一页</span>-->
    ...
    <div class="fd-ziliao">
        <div @click="showDetail(item)" v-for="(item,index) of list" data-aos="zoom-in-up" data-aos-duration="3000" class="kapian show">
...
.show{box-shadow: 0 15px 35px rgba(50, 50, 93, .1), 0 5px 15px rgba(0, 0, 0, .07);}
.fd-leirong{
    height: 70px;
    width: 1100px;
    background: #fff;
